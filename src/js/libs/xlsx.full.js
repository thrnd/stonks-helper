...
if(typeof module !== "undefined" && typeof require !== 'undefined') {
	if(typeof cptable === 'undefined') {
		if(typeof global !== 'undefined') global.cptable = require('../../../node_modules/xlsx/dist/cpexcel.js');
		else if(typeof window !== 'undefined') window.cptable = require('../../../node_modules/xlsx/dist/cpexcel.js');
	}
}
...
if(typeof exports !== 'undefined') {
	if(typeof module !== 'undefined' && module.exports) {
		if(typeof jszip === 'undefined') jszip = require('../../../node_modules/xlsx/jszip.js');
	}
}
...
0x3B: 1
	...
	function dsv_to_sheet_str(str, opts) {
		...
		var csvQuotationChar = o.csvQuotationChar || 0x22;
		...
		outer: for(;end < str.length;++end) switch((cc=str.charCodeAt(end))) {
			case csvQuotationChar: instr = !instr; break;
...
function sheet_to_csv(sheet, opts) {
    ...
    var regexpChars = ["|", "^"];
	var endregex = new RegExp((regexpChars.indexOf(FS) !== -1 ? `\\${FS}` : FS)+"+$");
	var row = "", cols = [];
